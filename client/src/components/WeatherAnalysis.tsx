        ...
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <AlertTriangle className="w-6 h-6 text-accent" /> {t('weatherAnalysis.insightsTitle')}
            </CardTitle>
          </CardHeader>
          <CardContent>
            {data.insights_text ? (
              <div className="prose prose-sm dark:prose-invert max-w-none">
                <ReactMarkdown>{data.insights_text}</ReactMarkdown>
              </div>
            ) : (
              <p className="text-muted-foreground">No insights were generated by the AI.</p>
            )}
          </CardContent>
        </Card>
      </div>

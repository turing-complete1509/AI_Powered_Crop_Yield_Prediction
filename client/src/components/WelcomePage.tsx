        ...
        <div className={`text-center transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          <div className="bg-card/95 backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-card max-w-2xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              Smart weather insights for smarter farming. Get personalized crop recommendations 
              and real-time weather analysis powered by AI.
            </p>
            <Button 
              onClick={onGetStarted}
              size="lg"
              className="bg-gradient-field hover:shadow-glow transition-all duration-300 transform hover:scale-105 px-8 py-3 text-lg font-semibold"
            >
              Get Started
            </Button>
          </div>
